...
bool CANReceiver::get_leg_up_FR()
{
	while(!walk_command.semaphore);
	return (bool)walk_command.data.leg_up.FR;
}

bool CANReceiver::get_leg_up_FL()
{
	while(!walk_command.semaphore);
	return (bool)walk_command.data.leg_up.FL;
}

bool CANReceiver::get_leg_up_RR()
{
	while(!walk_command.semaphore);
	return (bool)walk_command.data.leg_up.RR;
}

bool CANReceiver::get_leg_up_RL()
{
	while(!walk_command.semaphore);
	return (bool)walk_command.data.leg_up.RL;
}
